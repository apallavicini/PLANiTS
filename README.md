...
"SEQ_Viridiplantae.tar.gz" and "TAXONOMY_Viridiplantae.tar.gz" archives contain the same datasets in QIIME2 format, which requires sequences and related taxonomy in two separate files. 
