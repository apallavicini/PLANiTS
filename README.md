...
## Repository content
"table_families.pdf" contains Families and orders included in the dataset and total families reported in NCBI.The sequences used to build the database were downloaded from NCBI GenBank.
